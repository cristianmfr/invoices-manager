...
if (!fs.existsSync(path.join(__dirname, 'schema.prisma'))) {
	const alternativePaths = [
		'src/app/shared/prisma/generated',
		'app/shared/prisma/generated',
	]
...
path.join(
	process.cwd(),
	'src/app/shared/prisma/generated/libquery_engine-darwin-arm64.dylib.node',
)
// file annotations for bundling tools to include these files
path.join(__dirname, 'schema.prisma')
path.join(process.cwd(), 'src/app/shared/prisma/generated/schema.prisma')
